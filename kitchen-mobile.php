  ...
  <body>
    ...
    <div id="scene">
      <a-scene embedded>
        ...
        <!-- PARTICLES -->
        <a-entity id="particles" scale="0.08 0.05 0.08" position="0 3.5 0" particle-system="preset: dust; color: #EF0000; particleCount: 600; size: 0.2; opacity: 1; maxAge: 3"></a-entity>
